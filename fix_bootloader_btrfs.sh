...
echo "Arch Linux Bootloader Fix Script for Btrfs Filesystem"

# Instructions
echo "Instructions:"
echo "1. Boot into Arch Linux live environment."
echo "2. Mount your root partition to /mnt with Btrfs subvolumes. For example:"
echo "   mount -o subvol=@ /dev/sda2 /mnt"
echo "3. Run this script with root privileges:"
echo "   sudo ./fix_bootloader_btrfs.sh"
echo
...
# Mount the root partition with Btrfs subvolumes
echo "Mounting the root partition with Btrfs subvolumes..."
