...
echo "Arch Linux Font Improvement Script"
...
# Install Microsoft core fonts (ttf-ms-fonts)
...
# Create a .Xresources file for additional tweaks
echo "Creating ~/.Xresources for additional font tweaks..."
cat > ~/.Xresources <<EOF
Xft.dpi: 96
Xft.antialias: 1
Xft.rgba: rgb
